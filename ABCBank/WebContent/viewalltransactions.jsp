...
<%int balance =Integer.parseInt(String.valueOf(session.getAttribute("currbalance").toString())); %>
...
<%
	transactions = (List<TransactionM>)session.getAttribute("Lastfivetransactions");
